...
int result = (6 % 4);           // the remainder is 2 because 6/4 = 1 (As a whole number) and thus calculates 6-4 to get the remaining two numbers. 
                                //It is typically unnecessary to use a float || double to store the result of a modulo operation unless one or both inputs are floats || doubles.
int resultTwo = (1252 % 42);
